 ...
 * table. The connection to db is established in the constructor. The connection is closed in the {@link PersonDAOImpl#destroy()}
 * method
 */
@Component
public class PersonDAOImpl implements PersonDAO {
  ...
  public PersonDAOImpl(DataSource dataSource) throws SQLException {
